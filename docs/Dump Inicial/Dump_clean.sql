CREATE DATABASE  IF NOT EXISTS `sipro` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `sipro`;
USE `sipro`;
...
CREATE TABLE `prestamo` (
  ...
  CONSTRAINT `fkprestamocooperante` FOREIGN KEY (`cooperantecodigo`, `cooperanteejercicio`) REFERENCES `sipro`.`cooperante` (`codigo`, `ejercicio`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-04-05 10:34:15
