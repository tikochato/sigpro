	...
	<div ng-controller="subcomponentepropiedadController as subcomponentepropiedadc" class="maincontainer all_page" id="title">
		...
		<div class="row second-main-form" ng-show="subcomponentepropiedadc.mostraringreso">	
    		...
    		<div class="operation_buttons" align="right">
			  <div class="btn-group">
			    <shiro:hasPermission name="6020">
			      <label class="btn btn-success" ng-click="form.$valid ? subcomponentepropiedadc.guardar() : ''" ng-disabled="!form.$valid" uib-tooltip="Guardar">
			      <span class="glyphicon glyphicon-floppy-saved"></span> Guardar</label>
			    </shiro:hasPermission>
			    <label class="btn btn-primary" ng-click="subcomponentepropiedadc.irATabla()" uib-tooltip="Ir a Tabla">
