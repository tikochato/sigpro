				...
				for(i=0; i<meta.planificado.length; i++){
					if(meta.planificado[i].ejercicio == anio){
						...
						mi.planificado = {
							...
							eneroTiempo: meta.planificado[i].eneroTiempo != null ? moment(meta.planificado[i].eneroTiempo,'DD/MM/YYYY').toDate() : inicial,
							febreroTiempo: meta.planificado[i].febreroTiempo != null ? moment(meta.planificado[i].febreroTiempo,'DD/MM/YYYY').toDate() : inicial,
							marzoTiempo: meta.planificado[i].marzoTiempo != null ? moment(meta.planificado[i].marzoTiempo,'DD/MM/YYYY').toDate() : inicial,
							abrilTiempo: meta.planificado[i].abrilTiempo != null ? moment(meta.planificado[i].abrilTiempo,'DD/MM/YYYY').toDate() : inicial,
							mayoTiempo: meta.planificado[i].mayoTiempo != null ? moment(meta.planificado[i].mayoTiempo,'DD/MM/YYYY').toDate() : inicial,
							junioTiempo: meta.planificado[i].junioTiempo != null ? moment(meta.planificado[i].junioTiempo,'DD/MM/YYYY').toDate() : inicial,
							julioTiempo: meta.planificado[i].julioTiempo != null ? moment(meta.planificado[i].julioTiempo,'DD/MM/YYYY').toDate() : inicial,
							agostoTiempo: meta.planificado[i].agostoTiempo != null ? moment(meta.planificado[i].agostoTiempo,'DD/MM/YYYY').toDate() : inicial,
							septiembreTiempo: meta.planificado[i].septiembreTiempo != null ? moment(meta.planificado[i].septiembreTiempo,'DD/MM/YYYY').toDate() : inicial,
							octubreTiempo: meta.planificado[i].octubreTiempo != null ? moment(meta.planificado[i].octubreTiempo,'DD/MM/YYYY').toDate() : inicial,
							noviembreTiempo: meta.planificado[i].noviembreTiempo != null ? moment(meta.planificado[i].noviembreTiempo,'DD/MM/YYYY').toDate() : inicial,
							diciembreTiempo: meta.planificado[i].diciembreTiempo != null ? moment(meta.planificado[i].diciembreTiempo,'DD/MM/YYYY').toDate() : inicial,
							total: inicial
						}
