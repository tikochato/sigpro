...
<div class="modal-body" id="modal-body">
	<div class="row" ng-show="modalBuscar.tipo_vista==0">
	  	<div class="col-sm-12" style="font-weight: bold;">Buscar permiso</div>
	</div>
	<div ng-show="modalBuscar.tipo_vista==0" class="row">
	    <div class="col-sm-12 operation_buttons" align="right">
		    <div class="btn-group">
		    	<label class="btn btn-default" ng-click="modalBuscar.selecciorTodo()"> Seleccionar Todos</label>
		    	<label class="btn btn-default" ng-click="modalBuscar.deseleccionarTodo()">Quitar Todos</label>		       
	    	</div>
	    </div>
  </div>
  <div class="row">
