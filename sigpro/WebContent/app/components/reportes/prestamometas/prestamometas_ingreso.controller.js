var app = angular.module('prestamometasingresoController', [ 'ui.grid.edit', 'ui.grid.rowEdit',]);


app.controller('prestamometasingresoController',['$scope','$http','$interval','i18nService','Utilidades','$routeParams','$window','$location','$route','uiGridTreeBaseService','$mdDialog','$uibModal', '$document','$timeout','$q','$filter',
