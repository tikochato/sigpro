		    		...
		    		<div class="divPadreNombres"  style="height: 100%">
			    		<div class="divTabla"  style="height: 100%"> 
			    			<table class="table table-striped tablaDatos"  style="height: 100%">
								...
								<tbody vs-repeat class="cuerpoTablaNombres" id="divTablaNombres" style="max-height: 300px;" onmouseover="activarScroll(this.id)" onscroll="scrollEspejo(this)" scrollespejoflujo>
		    		...
		    		<div class="divPadreDatos" style="max-width: {{flujoc.tamanoTotal}}px; height: 100%; margin-top: 3px;">
	    				<div class="divTabla"  style="height: 100%">
			    			<table class="table table-striped tablaDatos" 
								...
								<tbody vs-repeat class="cuerpoTablaDatos" id="divTablaDatos" onmouseover="activarScroll(this.id)" onscroll="scrollEspejo(this)" style="max-height: 300px;" scrollespejoflujo>
		    			...
		    			<table class="table table-striped tablaDatos"  style="height: 100%">
							...
							<tbody vs-repeat class="cuerpoTablaTotales bordeIzquierda" id="divTotales" style="max-height: 300px;" onmouseover="activarScroll(this.id)" onscroll="scrollEspejo(this)" scrollespejoflujo>
