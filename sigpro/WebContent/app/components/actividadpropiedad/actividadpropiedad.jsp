	...
	<div ng-controller="actividadpropiedadController as actividadpropiedadc" class="maincontainer all_page" id="title">
		...
		<div class="row" align="center" ng-hide="actividadpropiedadc.mostraringreso">
    		...
    		<div class="col-sm-12" align="center">
				...
				<br/>
				<div class="total-rows">Total de {{  actividadpropiedadc.totalActividadPropiedades + (actividadpropiedadc.totalActividadPropiedades == 1 ? " Propiedad de Actividad" : " Propiedades de Actividades" ) }}</div>
		...
		<div class="row second-main-form" ng-show="actividadpropiedadc.mostraringreso">
    		...
    		<div class="col-sm-12 operation_buttons" align="right">
				<div class="btn-group">
					<shiro:hasPermission name="2020">
						<label class="btn btn-success" ng-click="form.$valid ? actividadpropiedadc.guardar() : ''" ng-disabled="!form.$valid" uib-tooltip="Guardar">
						<span class="glyphicon glyphicon-floppy-saved"></span> Guardar</label>
					</shiro:hasPermission>
					<label class="btn btn-primary" ng-click="actividadpropiedadc.irATabla()" uib-tooltip="Ir a Tabla">
			...
			<div class="col-sm-12">
				<form name="form">
						<div class="form-group">
							<label for="id" class="floating-label id_class">ID {{ actividadpropiedadc.actividadpropiedad.id }}</label>
							<br/><br/>
						</div>
						<div class="form-group">
