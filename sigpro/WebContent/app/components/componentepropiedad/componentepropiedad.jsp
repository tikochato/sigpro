			...
			<div class="col-sm-12">
				<form name="form">
						<div class="form-group">
							<label for="id" class="floating-label id_class">ID {{ componentepropiedadc.componentepropiedad.id }}</label>
							<br/><br/>
						</div>
						<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="form-group">
				    						...
				    						<p>{{ componentepropiedadc.componentepropiedad.fechaCreacion }}</p>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group" style="text-align: right">
				    						...
				    						<p>{{ componentepropiedadc.componentepropiedad.usuarioActualizo }}</p>
										</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<label for="fechaActualizacion" class="label-form" >Fecha de actualizacion</label>
				    						<p>{{ componentepropiedadc.componentepropiedad.fechaActualizacion }}</p>
										</div>
									</div>
								</div>
							</div>
