		    ...
		    <div class="collapse navbar-collapse" id="navBar">
	            <ul class="nav navbar-nav">
                    ...
                    <shiro:hasPermission name="24010">
	                    <li uib-dropdown>
	                    	<a href="#" uib-dropdown-toggle><span class="glyphicon" aria-hidden="true"></span> ${proyecto}s <b class="caret"></b></a> 
                    ...
                    <li uib-dropdown>
                    	...
                    	<ul uib-dropdown-menu role="menu" aria-labelledby="split-button">
                    		<shiro:hasPermission name="24010"><li role="menuitem"><a href="/main.jsp#!/avanceactividades">Avance de Actividades de Hitos</a></li></shiro:hasPermission>                    		
