		...
		mi.open = function (posicionlat, posicionlong) {
		  ...
		  mi.t_borrar = function(ev) {
				...
				var modalInstance = $uibModal.open({
					...
					resolve : {
						...
						$fechaInicio : function() {
							return mi.subcomponente.fechaFin;
						},
						$fechaFin : function() {
							return mi.subcomponente.fechaInicio;
						}
			...
			mi.agregarPagos = function() {
				var resultado = mi.llamarModalPagosPlanificados(mi.subcomponente.id,2, 
				...
				}, mi.subcomponente.costo != null ? mi.subcomponente.costo : 0);
