		...
		<div class="col-sm-12">
			<form name="form">
				<div class="form-group">
					<label for="id" class="floating-label">ID {{ controller.responsableTipo.id }}</label>
					<br/><br/>
				</div>
				
				<div class="form-group">
			      <input type="text" name="inombre"  class="inputText" id="inombre" ng-model="controller.responsableTipo.nombre" ng-value="controller.responsableTipo.nombre" onblur="this.setAttribute('value', this.value);" ng-required="true" >
