			...
			<div class="col-sm-12">
				<form name="actividadc.mForm">
					<uib-tabset active="actividadc.activeTab">
						...
						<div class="form-group">
    						<div class="form-group">
							   <input type="text" name="inombre"  class="inputText" id="inombre" ng-model="actividadc.actividad.nombre" ng-value="actividadc.actividad.nombre"  onblur="this.setAttribute('value', this.value);" ng-required="true" ng-readonly="actividadc.actividad.congelado" >
						...
						<div class="form-group-row row" >
								...
								<table style="width: 100%">
									<tr>
										<td style="width: 14%; padding-right:5px;">
											<input name="programa" type="number" class="inputText" ng-model="actividadc.actividad.programa" ng-value="actividadc.actividad.programa" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;"  ng-readonly="actividadc.actividad.congelado"/>
							       			<label class="floating-label">Programa</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.subprograma" ng-value="actividadc.actividad.subprograma" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
							  				<label class="floating-label">Subprograma</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.proyecto" ng-value="actividadc.actividad.proyecto" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
							  				<label class="floating-label">Proyecto</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.actividad" ng-value="actividadc.actividad.actividad" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
								  			<label class="floating-label">Actividad</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.obra" ng-value="actividadc.actividad.obra" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
							 				<label class="floating-label">Obra</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.renglon" ng-value="actividadc.actividad.renglon" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
							  				<label class="floating-label">Renglón</label>
										</td>
										<td style="width: 14%; padding-right:5px;">
											<input type="number" class="inputText" ng-model="actividadc.actividad.ubicacionGeografica" ng-value="actividadc.actividad.ubicacionGeografica" onblur="this.setAttribute('value', this.value);" ng-maxlength="4" style="text-align: center;" ng-readonly="actividadc.actividad.congelado"/>
							...
							<div class="form-group">
								<div id="tipoNombre" angucomplete-alt placeholder="" pause="100" selected-object="actividadc.cambioTipo"
								  ...
								  initial-value="actividadc.actividad.actividadtiponombre" focus-out="actividadc.blurTipo()" input-name="tipoNombre" disable-input="actividadc.actividad.congelado"></div>
							</div>
						<div class="row">
							<div class="col-sm-6">
								<div class="form-group">
								   <input class="inputText"  type="number"
								     ...
								     ng-readonly="actividadc.actividad.tieneHijos || actividadc.actividad.congelado">
								...
								<div class="form-group">
									<select class="inputText" ng-model="actividadc.duracionDimension"
										ng-options="dim as dim.nombre for dim in actividadc.dimensiones track by dim.value"
										 ng-required="true" ng-readonly="actividadc.actividad.congelado">
									</select>
						...
						<div class="form-group" >
							<div id="acumulacionCosto" angucomplete-alt placeholder="" pause="100" selected-object="actividadc.cambioAcumulacionCosto"
									...
									initial-value="actividadc.actividad.acumulacionCostoNombre" focus-out="actividadc.blurAcumulacionCosto()" input-name="acumulacionCosto" disable-input="actividadc.actividad.congelado"></div>
						...
						<div class="form-group" >
						    <input type="text" class="inputText" id="iproyt" name="iproyt" ng-model="actividadc.coordenadas" ng-value="actividadc.coordenadas" 
								 ng-click="actividadc.actividad.congelado?'':actividadc.open(actividadc.actividad.latitud, actividadc.actividad.longitud); " onblur="this.setAttribute('value', this.value);" ng-readonly="true"/>
							<span class="label-icon" ng-click="actividadc.actividad.congelado?'':actividadc.open(actividadc.actividad.latitud, actividadc.actividad.longitud); " tabindex="-1"><i class="glyphicon glyphicon-map-marker"></i></span>
							...
							<div ng-switch="campo.tipo">
								<div ng-switch-when="texto" class="form-group" >
									<input type="text" id="{{ 'campo_'+campo.id }}" ng-model="campo.valor" class="inputText" 
										ng-value="campo.valor" onblur="this.setAttribute('value', this.value);" ng-readonly="actividadc.actividad.congelado"/>	
								...
								<div ng-switch-when="booleano" class="form-group" >
									<input type="checkbox" id="{{ 'campo_'+campo.id }}" ng-model="campo.valor"  ng-readonly="actividadc.actividad.congelado"/>
									<label class="floating-label">{{ campo.label }}</label>
								</div>
								...
								<div ng-switch-when="select" class="form-group" >
									<select id="{{ 'campo_'+campo.id }}" class="inputText" ng-model="campo.valor" ng-readonly="actividadc.actividad.congelado">
				...
				<div align="center">
						...
						<div style="text-align: right;">
							<div class="btn-group" role="group" aria-label="">
								<a class="btn btn-default" href
									ng-click="actividadc.actividad.congelado?'':actividadc.buscarActividadResponsable()" role="button"
									ng-disabled="actividadc.actividad.congelado"
					...
					<tbody>
						<tr st-select-row="row"
							...
							<td>
								<button type="button"
									ng-click="actividadc.actividad.congelado?'':actividadc.eliminarResponsable(row)"
									ng-disabled="actividadc.actividad.congelado"
