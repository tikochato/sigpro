 ...
 * 
 */
var moduloEntidad = angular.module('moduloEntidad', [
    'ngTouch'
]);

moduloEntidad.controller('controlEntidad', [
	'$scope', '$routeParams', '$uibModal', '$http', '$interval',
	'i18nService', 'Utilidades', '$timeout', '$log', controlEntidad
]);

function controlEntidad($scope, $routeParams, $uibModal, $http, $interval, i18nService, $utilidades, $timeout, $log) {
