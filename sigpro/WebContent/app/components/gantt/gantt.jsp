<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div ng-controller="ganttController as ganttc" class="maincontainer all_page" id="title">
	    ...
	    <form>
			...
			<div class="btn-group">
			<!-- 
				<label class="btn btn-primary"  style=" padding: 1px;"  >
					<span >
						<input type="text" class="form-control" ng-model="ganttc.nombreArchivo" 
							style=" height: 30px;" placeholder="Seleccione archivo" ng-readonly="true" >
					</span> 
				</label>
				<input  id="file" name="file" type="file" custom-on-change="cargarArchivo"
				 file-upload multiple style="display: none;" >
		...
		<div class="kanban-board" >
			<div ds:kanban-board items="itemsKanban" groups="groups" states="states" assignable-resources="assignableResources"
