...
public class InfId implements java.io.Serializable {
	...
	public InfId(Date fechaCorte, String noPrestamo, String codigoPresupuestario, String nombrePrograma,
			Integer codigoOrganismoFinan, String siglasOrganismoFinan, String nombreOrganismoFinan,
	...
	@Column(name = "no_prestamo", length = 100)
	...
	@Column(name = "nombre_programa", length = 100)
	...
	@Column(name = "nombre_organismo_finan", length = 1000)
	...
	@Column(name = "moneda_prestamo", length = 45)
	...
	@Column(name = "estado_prestamo", length = 100)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof InfId))
			return false;
		InfId castOther = (InfId) other;
