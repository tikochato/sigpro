...
public class ObjetoRecurso  implements java.io.Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2502903618756726230L;
    ...
    public ObjetoRecurso(ObjetoRecursoId id, String usuarioCreo, Date fechaCreacion, int estado) {
        this.id = id;
        this.usuarioCreo = usuarioCreo;
        this.fechaCreacion = fechaCreacion;
        this.estado = estado;
    }
    public ObjetoRecurso(ObjetoRecursoId id, String usuarioCreo, String usuarioActualizo, Date fechaCreacion, Date fechaActualizacion, int estado, Integer valorEntero, String valorString, BigDecimal valorDecimal, Date valorTiempo) {
       this.id = id;
       this.usuarioCreo = usuarioCreo;
