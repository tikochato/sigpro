...
//		response.getWriter().append("Served at: ").append(request.getContextPath());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		try{
			...
			if(accion.equals("generarInforme")){
				...
				//TODO: lineaBase
				List<ObjetoCosto> lstPrestamo = ObjetoDAO.getEstructuraConCosto(idPrestamo, anioInicial, anioFinal, true, true, null, usuario);
	...
	private byte[] exportarExcel(int prestamoId, int anioInicio, int anioFin, int agrupacion, int tipoVisualizacion, String lineaBase, String usuario){
		...
		try{			
			...
			//TODO: lineaBase
			List<ObjetoCosto> lstPrestamo = ObjetoDAO.getEstructuraConCosto(prestamoId, anioInicio, anioFin, true, true, lineaBase, usuario);
