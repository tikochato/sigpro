...
public class SPlanEjecucion extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(accion.equals("getDatosPlan")){
			...
			if(prestamo != null){
				double ejecucionFisicaReal = calcularEjecucionFisicaReal(prestamo);
				BigDecimal ejecucionFinancieraPlanificada = calcularEjecucionFinanciaeraPlanificada(prestamo, prestamo.getCodigoPresupuestario()+"", new Date());
				Double plazoEjecucionPlanificada = calcularPlazoEjecucionPlanificada(prestamo);
				BigDecimal ejecucionFisicaPlanificada = calcularEjecucionFisicaPlanificada(prestamo);
	...
	public double calcularEjecucionFisicaReal(Prestamo prestamo){
	...
	public BigDecimal calcularEjecucionFinanciaeraPlanificada(Prestamo prestamo, String codigoPresupuestario,Date fecha){
	...
	public Double calcularPlazoEjecucionPlanificada(Prestamo prestamo){
		Set<Proyecto> proyectos = prestamo.getProyectos();
	...
	public BigDecimal calcularEjecucionFisicaPlanificada(Prestamo prestamo){
