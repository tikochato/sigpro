...
public class SResponsableRol extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(accion.equals("getResponsableRoles")){
			List<ResponsableRol> responsableRoles = ResponsableRolDAO.getResponsableRol(1);
			List<stresponsablerol> stResponsableRoles = new ArrayList<>();
			for (ResponsableRol responsableRol : responsableRoles){
				...
				temp.descrpipcion = responsableRol.getDescripcion();
				temp.responsabelTipoId = responsableRol.getResponsableTipo().getId();
